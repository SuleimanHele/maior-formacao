...
const TrainerSection = () => {
  ...
  return (
    <>
      <section id="formadores" className="relative overflow-hidden py-24 bg-muted">
        ...
        <div className="container relative z-10">
          ...
          <div className="max-w-3xl mx-auto text-center mb-20">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              Formadores experientes focados em aplicação prática, resultados reais e crescimento profissional.
            </p>
          </div>
      ...
      {selectedTrainer && (
        ...
        >
          <div
            className="relative w-full max-w-5xl overflow-hidden rounded-[32px] border border-white/10 bg-zinc-950 shadow-2xl"
